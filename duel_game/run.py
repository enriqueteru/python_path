...
def Game(player1 : Player, player2: Player):  
        ...
        while player1.get_health() > 0 and player2.get_health() > 0 : 
         ...
         print(player2.name + ' attack to ' + player1.name + ' total health: ' + str(player1.get_health()) )
         player2.set_strike(randint(1,50))
         print(player1.name + ' attack to ' + player2.name + ' total health: ' + str(player2.get_health()) )
        else:
